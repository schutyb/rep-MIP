...
cada vez que calcule un hist de la fase y otro del módulo lo voy sumando al siguiente así tengo los
histogramas totales para fase y módulo.
"""
...
# the path to the folder where the data is store.
...
# ahora creo los files en ome.tiff para guardar los histogramas de módulo y fase
hist_phase = np.asarray([hist_ph, bins_ph], dtype=float)
hist_mod = np.asarray([hist_md, bins_md], dtype=float)
fname_phase = '/home/bruno/Documentos/Proyectos/TESIS/TESIS/Data/Modelo_melanomas/hist_phase.ome.tiff'
fname_mod = '/home/bruno/Documentos/Proyectos/TESIS/TESIS/Data/Modelo_melanomas/hist_mod.ome.tiff'
